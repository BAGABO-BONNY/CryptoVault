...
const translations = {
  en: {
    ...
    tryAgain: 'Try Again',
    fileTooBig: 'File size exceeds the limit',
    ...
    active: 'Active',
    inactive: 'Inactive',
    totalEncrypted: 'Total Encrypted',
    keysGenerated: 'Keys Generated',
    totalOperations: 'Total Operations',
    hashOperations: 'Hash Operations',
    signatureOperations: 'Signature Operations',
    activeUsers: 'Active Users',
    newUserToday: 'new user today',
    fromLastMonth: 'from last month',
    users: 'Users',
    activities: 'Activities',
    analytics: 'Analytics',
    recentActivities: 'Recent Activities',
    yourRecentActivities: 'Your Recent Activities',
    recentActivitiesDesc: 'View your most recent cryptographic operations',
    noActivitiesFound: 'No activities found',
    usageAnalytics: 'Usage Analytics',
    algorithmUsage: 'Algorithm Usage',
    operationDistribution: 'Operation Distribution',
    noAlgorithmData: 'No algorithm usage data available',
    ...
    dashboardSubtitle: 'here\'s an overview of your cryptographic activities',
    launch: 'Launch',
    accountOverview: 'Account Overview',
    storageUsage: 'Storage Usage',
    accountStatus: 'Account Status',
    basicPlanDetails: 'Basic Plan - Unlimited operations',
    thisMonth: 'This month',
    operationStats: 'Operation Stats',
    usageOverTime: 'Usage Over Time',
    usageOverTimeDesc: 'View your cryptographic operations usage over time',
    analyticsComingSoon: 'Advanced analytics coming soon',
    encryptionTool: 'Encryption',
    decryptionTool: 'Decryption',
    hashingTool: 'Hashing',
    signatures: 'Signatures',
    keyGenerationLabel: 'Key Generation',
    digitalSignaturesLabel: 'Digital Signatures',
    encryptionToolDesc: 'Secure your sensitive data using strong encryption algorithms',
    decryptionToolDesc: 'Decrypt your previously encrypted data',
    hashingToolDesc: 'Generate cryptographic hashes for data integrity verification',
    digitalSignatureToolDesc: 'Create and verify digital signatures for document authenticity',
