  ...
  return (
    <div>
      <div className="sm:flex sm:items-center sm:justify-between mb-6">
        <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Encryption Tool</h1>
              ...
              <div>
                ...
                <div className="mt-1 flex rounded-md shadow-sm">
                  <Input
                    ...
                    placeholder={generateKey ? "A key will be generated automatically" : "Enter encryption key"}
                    className="flex-1"
                  />
                  <Button
                    type="button"
