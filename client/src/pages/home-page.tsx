    ...
    <div className="flex flex-col min-h-screen">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between md:space-x-10">
            <div className="md:w-1/2 mb-10 md:mb-0 z-10">
              ...
              <p className="text-xl text-slate-600 dark:text-slate-300 mb-8 leading-relaxed">
                ...
                protecting your sensitive information with military-grade encryption methods
                and intuitive tools.
              </p>
            ...
            <div className="md:w-1/2 z-10">
              <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-6 border border-slate-200 dark:border-slate-700 transition-all duration-300 hover:shadow-primary/10 relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <div className="rounded-xl bg-slate-100 dark:bg-slate-700 p-5 font-mono text-sm mb-4 shadow-inner">
                    ...
                    <div className="text-slate-800 dark:text-slate-200 mt-2">
                      <span className="text-blue-500 dark:text-blue-400">const</span> <span className="text-purple-500 dark:text-purple-400">encrypted</span> = <span className="text-yellow-500 dark:text-yellow-400">await</span> encrypt(
                      <br />
                      &nbsp;&nbsp;<span className="text-green-500 dark:text-green-400">"AES-256-GCM"</span>,
                      <br />
                      &nbsp;&nbsp;message,
                      <br />
                      &nbsp;&nbsp;key
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-700 p-8 rounded-2xl border border-slate-200 dark:border-slate-600 inline-block">
              ...
              <p className="text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
                All cryptographic operations are performed client-side using the latest Web Crypto API standards, 
                ensuring your sensitive data never leaves your device unencrypted.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl overflow-hidden">
              {faqs.map((faq, index) => (
                <div 
                  key={index} 
                  className={`border-b border-slate-200 dark:border-slate-700 ${index === faqs.length - 1 ? 'border-b-0' : ''}`}
                >
                  <button
                  ...
                  >
                    ...
                    <div className={`flex items-center justify-center w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-700 transition-transform duration-300 ${
                      activeFaq === index ? "rotate-180 bg-primary/10 text-primary dark:bg-primary/20" : ""
                    }`}>
      ...
      <section className="py-32 bg-gradient-to-br from-primary via-primary to-accent text-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden opacity-20 pointer-events-none">
          ...
          <div className="absolute top-[15%] left-[10%] text-white/30 text-7xl animate-float-slow">🔒</div>
          <div className="absolute top-[65%] left-[20%] text-white/20 text-5xl animate-float-medium">🔑</div>
          <div className="absolute top-[30%] right-[15%] text-white/20 text-6xl animate-float-fast">🛡️</div>
          <div className="absolute top-[70%] right-[10%] text-white/30 text-5xl animate-float-medium">🔐</div>
        </div>
        
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="inline-block mb-6 rounded-lg px-3 py-1 bg-white/10 backdrop-blur-md">
            <span className="text-white/90 font-medium text-sm">Secure Your Digital Future</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-extrabold mb-8 leading-tight max-w-4xl mx-auto">
            Ready to protect your most sensitive data with military-grade encryption?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Button
              ...
              variant="outline"
              onClick={() => navigate("/about")}
              className="border-white text-white hover:bg-white/10 transition-all px-8 py-6 text-lg"
            >
              Learn More
            </Button>
          </div>
          ...
          <div className="mt-16 max-w-3xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="flex flex-col items-center">
                ...
                <p className="text-white/70 text-sm">Client-side encryption keeps your data private</p>
              </div>
              <div className="flex flex-col items-center">
                <div className="bg-white/10 rounded-full p-4 mb-3">
                ...
                <p className="text-white/70 text-sm">Used by thousands of security professionals</p>
              </div>
              <div className="flex flex-col items-center">
                <div className="bg-white/10 rounded-full p-4 mb-3">
                ...
                <p className="text-white/70 text-sm">Works across all your devices and platforms</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="py-16 bg-slate-900 text-slate-400">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="pt-8 mt-8 border-t border-slate-800 text-center text-sm">
            <p>&copy; {new Date().getFullYear()} CryptoVault. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
